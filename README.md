# 🛍️ Stylish – Modern E-Commerce Website
...
- **❤️ Wishlist System** – Save your favorite products instantly.
- **🎞️ Hero Image Slide**r – Auto-playing banner with hover pause and navigation dots.
- **🔍 Interactive Search Bar** – Toggle search box with click-outside detection.
- **📱 Fully Responsive** – Works beautifully on all screen sizes, from mobile to desktop.
- **💌 Newsletter Subscription** – Includes input validation and success toast notification.
- **🔥 Scroll Animations (AOS)** – Elements animate smoothly when they appear in view.
